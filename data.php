...
if (isset($_SESSION['token_name'])){}else{header("location: login.php", true, 301);}	
?>
<html lang="en">
<head>
    <!-- Required meta tags -->
...
<body>
  ...
  <button type="button" id="btnPopUpBarang" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#inputBarang"style="display:none;">
	  Tambah
  </button>
  
  </br>
  <div class="refresh">
    <button id="refreshBarang" class="tambah1" style="border:none; padding: 4px 8px 4px 7px;"><i class="bi bi-plus"></i> Refresh</button>
  </div>
		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			  ...
			  <div class="mb-3">
				...
				<input type="input" class="form-control" id="inputBarangIdPegawai" value="<?php echo $_SESSION['id_pegawai'];?>" disabled>
			  </div>
			  <div class="mb-3">
			  ...
			  <div class="mb-3">
				...
				<select id="inputBarangSatuan" name="inputBarangSatuan" class="form-select" aria-label="Default select example">
		  ...
		  <div class="modal-footer">
		    <button id="btnUpdateBarang" name="btnUpdateBarang" type="button" class="btn btn-primary">Update</button>
			<button id="btnSubmitBarang" name="btnSubmitBarang" type="button" class="btn btn-primary">Insert</button>
			<button id="closeModalBarang" type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
		  </div>
		</div>
	  </div>
	</div>
